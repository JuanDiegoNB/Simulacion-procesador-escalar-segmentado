...
msg_result:  .asciiz "El número menor es: " 
...
start_comparison:
        # Inicializar el contador y el menor número
        li $t0, 0               # Contador de iteraciones
        li $t1, 2147483647      # Inicializar el número menor con el mayor posible (máx. positivo en 32 bits)
...
ask_numbers:
        ...
        bge $t2, $t1, skip      # Si $t2 >= $t1, no actualizar el menor
        move $t1, $t2           # Si $t2 es menor, actualizar $t1 con $t2
